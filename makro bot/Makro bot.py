...
from aiogram.types import InputFile, InlineKeyboardButton, InlineKeyboardMarkup, ReplyKeyboardMarkup, KeyboardButton, \
    CallbackQuery
import makro_kp as mk

API_TOKEN = '5544206318:AAH5_A4cguTgNmBRptjPaOdwV07LyHTpC9Q'
...
async def all2(message: types.Message):
    ...
    photo = InputFile('mol go`shti.jpg')
...
async def all2(message: types.Message):
    ...
    await message.delete()
    photo = InputFile('qoy go`shti.jpg')
    await message.answer_photo(photo=photo)
...
async def all2(message: types.Message):
    ...
    await message.delete()
    photo = InputFile('medium_1513165848502020401-00118.jpg')
...
async def all2(message: types.Message):
    ...
    await message.delete()
    photo = InputFile('medium_1615876865540_MG_7630-1.jpg')
...
async def all2(message: types.Message):
    ...
    await message.delete()
    photo = InputFile('medium_164962632545632.jpg')
...
async def all2(message: types.Message):
    ...
    await message.delete()
    photo = InputFile('hanskiy sir.jpg')
...
async def all2(message: types.Message):
    await message.delete()
    photo = InputFile('pepsi 1.5l.jpg')
    await message.answer_photo(photo=photo)
...
async def all2(callback: types.CallbackQuery):
    photo =  InputFile('pepsi 0.5l.jpg')
...
async def all2(callback: types.CallbackQuery):
    photo =  InputFile('CocaCola1l.jpg')
...
async def all2(callback: types.CallbackQuery):
    photo =  InputFile('lipton 0.5l.jpg')
